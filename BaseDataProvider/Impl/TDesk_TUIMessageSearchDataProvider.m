...
typedef void (^LoadSearchMsgSucceedBlock)(BOOL isOlderNoMoreMsg, BOOL isNewerNoMoreMsg, NSArray<TDeskMessageCellData *> *newMsgs);
typedef void (^LoadMsgSucceedBlock)(BOOL isOlderNoMoreMsg, BOOL isNewerNoMoreMsg, BOOL isFirstLoad, NSArray<TDeskMessageCellData *> *newUIMsgs);

@interface TDeskMessageSearchDataProvider ()
...
@implementation TDeskMessageSearchDataProvider
