...
@class TDeskGroupPendencyCellData;
 ...
 */
@interface TDeskGroupPendencyDataProvider : NSObject

/**
 *  Request data list
 *  The object type stored in this list is TDeskGroupPendencyCellData.
 ...
 * TDeskGroupPendencyCellData and store it in the datalist. (The request object pulled from the server is TIMGroupPendencyItem).
 */
- (void)loadData;

/**
 *  Approve current request data.
 *  This function directly calls accept implemented in TDeskGroupPendencyCellData, and the unread count is decremented by 1.
 */
- (void)acceptData:(TDeskGroupPendencyCellData *)data;

/**
 *  Deny the current request data.
 *  Remove the data in the parameter from the datalist, and call reject implemented in TDeskGroupPendencyCellData, while the unread count is decremented by 1.
 */
