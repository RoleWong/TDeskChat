//
//  TDeskChatCallingDataProvider.h
//  TUIChat
//
...
@protocol TDeskChatCallingInfoProtocol <NSObject>
...
@interface TDeskChatCallingDataProvider : NSObject <TDeskChatCallingDataProtocol>
