...
#import "TDesk_TUIChatSmallTongueView_Minimalist.h"
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        UIImage *bkImage = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"small_tongue_bk")];
...
+ (UIImage *)getTongueImage:(TUIChatSmallTongue_Minimalist *)tongue {
    ...
    switch (tongue.type) {
        case TUIChatSmallTongueType_ScrollToBoom: {
            tongueImage = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"small_tongue_scroll_to_boom")];
        } break;
        case TUIChatSmallTongueType_ReceiveNewMsg: {
            tongueImage = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"small_tongue_scroll_to_boom")];
            break;
        ...
        case TUIChatSmallTongueType_SomeoneAt: {
            tongueImage = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"small_tongue_someone_at_me")];
        } break;
        default:
            break;
    }
