 ...
 */
- (void)messageController:(TUIBaseMessageController_Minimalist *)controller onLongSelectMessageAvatar:(TDeskMessageCell *)cell;
 ...
 */
- (void)messageController:(TUIBaseMessageController_Minimalist *)controller onRelyMessage:(TDeskMessageCellData *)data;
