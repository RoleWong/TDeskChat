...
#import "TDesk_TUIBaseMessageController_Minimalist+ProtectedAPI.h"
...
- (void)onDelete:(TDeskMessageCell *)cell {
    TDeskMessageCellData *cellData = cell.messageData;
    @weakify(self);
...
- (void)updateAtMeTongue:(TDeskMessageCellData *)deleteCellData {
