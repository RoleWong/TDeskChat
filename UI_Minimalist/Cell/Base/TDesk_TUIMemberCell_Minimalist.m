...
@property(nonatomic, strong) TDeskMemberDescribeCellData *cellData;
...
#pragma mark - Public
- (void)fillWithData:(TDeskMemberDescribeCellData *)cellData {
...
@property(nonatomic, strong) TDeskMemberCellData *cellData;
...
- (void)updateConstraints {
    ...
    if ([TDeskConfig defaultConfig].avatarType == TAvatarTypeRounded) {
        self.avatarView.layer.masksToBounds = YES;
        self.avatarView.layer.cornerRadius = imgWidth / 2;
    } else if ([TDeskConfig defaultConfig].avatarType == TAvatarTypeRadiusCorner) {
        self.avatarView.layer.masksToBounds = YES;
        self.avatarView.layer.cornerRadius = [TDeskConfig defaultConfig].avatarCornerRadius;
    }
