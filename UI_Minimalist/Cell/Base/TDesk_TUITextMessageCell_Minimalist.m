...
+ (CGFloat)getHeight:(TDeskMessageCellData *)data withWidth:(CGFloat)width {
    NSAssert([data isKindOfClass:TDeskTextMessageCellData.class], @"data must be kind of TDeskTextMessageCellData");
    TDeskTextMessageCellData *textCellData = (TDeskTextMessageCellData *)data;
...
+ (CGSize)getContentSize:(TDeskMessageCellData *)data {
    ...
    CGFloat y = textCellData.cellLayout.bubbleInsets.top + [TDeskBubbleMessageCell_Minimalist getBubbleTop:textCellData];
