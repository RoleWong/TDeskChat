...
@interface TUIFileMessageCell_Minimalist () <V2TIMSDKListener, TDeskMessageProgressManagerDelegate>
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        _fileImage.image = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath(@"msg_file")];
        ...
        _downloadImage.image = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"file_download")];
