...
#import "TDesk_TUIImageReplyQuoteView_Minimalist.h"
#import "TDesk_TUIMergeReplyQuoteView_Minimalist.h"
#import "TDesk_TUIReplyQuoteView_Minimalist.h"
#import "TDesk_TUITextMessageCell_Minimalist.h"
#import "TDesk_TUITextReplyQuoteView_Minimalist.h"
#import "TDesk_TUIVideoReplyQuoteView_Minimalist.h"
#import "TDesk_TUIVoiceReplyQuoteView_Minimalist.h"
...
- (void)fillWithData:(TDeskReferenceMessageCellData *)data {
    ...
    if (self.bubbleData.direction == MsgDirectionIncoming) {
        lineImage = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"msg_reply_line_income")];
    } else {
        lineImage = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"msg_reply_line_outcome")];
    }
...
- (void)notifyBottomContainerReadyOfData:(TDeskMessageCellData *)cellData {
    ...
    [TDeskCore raiseExtension:TUICore_TUIChatExtension_BottomContainer_MinimalistExtensionID parentView:self.bottomContainer param:param];
}
...
- (TUIReplyQuoteView_Minimalist *)getCustomOriginView:(TDeskMessageCellData *)originCellData {
...
+ (CGSize)getContentSize:(TDeskMessageCellData *)data {
    ...
    CGFloat y = referenceCellData.cellLayout.bubbleInsets.top + [TDeskBubbleMessageCell_Minimalist getBubbleTop:referenceCellData];
    ...
    if (referenceCellData.direction == MsgDirectionIncoming) {
        size.height = MAX(size.height, TDeskBubbleMessageCell_Minimalist.incommingBubble.size.height);
    } else {
        size.height = MAX(size.height, TDeskBubbleMessageCell_Minimalist.outgoingBubble.size.height);
    }
