...
- (void)updateUI:(TDeskReplyMessageCellData *)replyData {
...
+ (CGFloat)getHeight:(TDeskMessageCellData *)data withWidth:(CGFloat)width {
    NSAssert([data isKindOfClass:TDeskReplyMessageCellData.class], @"data must be kind of TDeskReplyMessageCellData");
    TDeskReplyMessageCellData *replyCellData = (TDeskReplyMessageCellData *)data;
