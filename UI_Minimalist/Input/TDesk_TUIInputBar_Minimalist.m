...
#import "TDesk_TUIInputBar_Minimalist.h"
...
#import "TDesk_TUIAudioRecorder.h"

@interface TUIInputBar_Minimalist () <UITextViewDelegate, TDeskAudioRecorderDelegate>

@property(nonatomic, strong) NSDate *recordStartTime;
@property(nonatomic, strong) TDeskAudioRecorder *recorder;
...
- (void)setupViews {
    ...
    [_moreButton setImage:[[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"TypeSelectorBtnHL_Black")]
    ...
    [_faceButton setImage:[[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"ToolViewEmotion")] forState:UIControlStateNormal];
    [_faceButton setImage:[[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"ToolViewEmotion")]
                 forState:UIControlStateHighlighted];
    ...
    [_micButton setImage:[[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"ToolViewInputVoice")]
                forState:UIControlStateNormal];
    ...
    [_cameraButton setImage:[[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"ToolViewInputCamera")]
                   forState:UIControlStateNormal];
    [_cameraButton setImage:[[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"ToolViewInputCamera")]
                   forState:UIControlStateHighlighted];
...
- (void)initRecordView {
    ...
    for (int i = 0; i < 6; i++) {
        ...
        [recordAnimateView setImage:[[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"voice_record_animation")]];
...
- (void)setRecordStatus:(TUIRecordStatus)status {
    switch (status) {
        ...
        case TUIRecordStatus_Cancel: {
            ...
            _recordDeleteView.image = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"voice_record_delete")];
        ...
        case TUIRecordStatus_Delete: {
            ...
            _recordDeleteView.image = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath_Minimalist(@"voice_record_delete_ready")];
...
- (void)addEmoji:(TDeskFaceCellData *)emoji {
    ...
    emojiTextAttachment.image = [[TDeskImageCache sharedInstance] getFaceFromCache:emoji.path];
...
#pragma mark - TDeskAudioRecorderDelegate
...
#pragma mark - Getter
- (TDeskAudioRecorder *)recorder {
    if (!_recorder) {
        _recorder = [[TDeskAudioRecorder alloc] init];
