...
#import "TDesk_TUIMenuCell_Minimalist.h"
...
@interface TUIInputController_Minimalist () <TUIInputBarDelegate_Minimalist, TUIMenuViewDelegate_Minimalist, TDeskFaceViewDelegate>
                                            ...
                                            callback:^(BOOL succ, NSString *_Nonnull error_message, NSArray *_Nonnull msgs) {
                                              if (succ) {
                                                  if (msgs.count > 0) {
                                                      ...
                                                      [[TDeskChatModifyMessageHelper defaultHelper] modifyMessage:rootMsg
