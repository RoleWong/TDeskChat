...
#import "TDesk_TUIChatObjectFactory_Minimalist.h"
...
+ (void)load {
    [TDeskCore registerObjectFactory:TUICore_TUIChatObjectFactory_Minimalist objectFactory:[TUIChatObjectFactory_Minimalist shareInstance]];
}
