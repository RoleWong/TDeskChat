...
@interface TDeskCaptureVideoPreviewViewController ()
...
@implementation TDeskCaptureVideoPreviewViewController
...
- (void)viewDidLoad {
    ...
    UIImage *commitImage = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath(@"camer_commit")];
    [self.commitButton setImage:commitImage forState:UIControlStateNormal];
    UIImage *commitBGImage = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath(@"camer_commitBg")];
    ...
    UIImage *cancelButtonBGImage = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath(@"camera_cancel")];
