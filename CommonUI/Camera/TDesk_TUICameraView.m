...
@property(nonatomic) TDeskCaptureTimer *timer;
@property(nonatomic) BOOL isVideoRecording;

@end

@implementation TDeskCameraView
...
- (void)setupUI {
    ...
    self.timer = ({
        TDeskCaptureTimer *timer = [TDeskCaptureTimer new];
...
- (TDeskCaptureVideoPreviewView *)previewView {
    if (!_previewView) {
        _previewView = [[TDeskCaptureVideoPreviewView alloc] init];
...
- (UIButton *)switchCameraButton {
    if (!_switchCameraButton) {
        ...
        UIImage *switchCameraButtonImage = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath(@"camera_switchCamera")];
...
- (UIButton *)closeButton {
    if (!_closeButton) {
        ...
        UIImage *closeButtonImage = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath(@"camera_back")];
...
- (UIButton *)pictureLibButton {
    if (!_pictureLibButton) {
        ...
        UIImage *pictureImage = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath(@"more_picture")];
