//
//  TDeskChatPopContextController.m
//  TUIChat
//
...
#import "TDesk_UIImage+ImageEffects.h"
#import <TDeskCore/TDesk_TUICore.h>

@interface TDeskChatPopContextController ()<V2TIMAdvancedMsgListener>
@property(nonatomic, strong) UIView *recentView;
@property(nonatomic, strong) UIView *alertContainerView;
@property(nonatomic, strong) TDeskMessageCell *alertView;
@property(nonatomic, strong) TDeskChatPopContextExtionView *extionView;
...
@implementation TDeskChatPopContextController
...
- (void)setBlurEffectWithView:(UIView *)view style:(TDeskBlurEffectStyle)blurStyle {
...
- (UIImage *)blurImageWithSnapshotImage:(UIImage *)snapshotImage style:(TDeskBlurEffectStyle)blurStyle {
    switch (blurStyle) {
