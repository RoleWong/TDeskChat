...
@implementation TDeskGroupPinCellView
- (instancetype)init {
    self = [super init];
    if (self) {
        [self setupView];
...
- (void)fillWithData:(TDeskMessageCellData *)cellData {
    ...
    self.titleLabel.text = [TDeskMessageDataProvider getShowName:cellData.innerMessage];
    self.content.text = [TDeskMessageDataProvider getDisplayString:cellData.innerMessage];
...
@interface TDeskGroupPinCell ()
@property (nonatomic, strong) UIView *separatorView;
@end
@implementation TDeskGroupPinCell
...
- (TDeskGroupPinCellView *)cellView {
    if (!_cellView) {
        _cellView = [[TDeskGroupPinCellView alloc] init];
