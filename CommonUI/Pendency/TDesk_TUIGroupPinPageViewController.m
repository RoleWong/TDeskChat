//
//  TDeskGroupPinPageViewController.m
//  TUIChat
//
...
@interface TDeskGroupPinPageViewController() <UITableViewDelegate,UITableViewDataSource>

@end

@implementation TDeskGroupPinPageViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    TDeskGroupPinCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
    if (cell == nil) {
        cell = [[TDeskGroupPinCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell"];
    }
    cell.backgroundColor = [UIColor systemGroupedBackgroundColor];
    V2TIMMessage *msg = self.groupPinList[indexPath.row];
    TDeskMessageCellData * cellData = [TDeskMessageDataProvider getCellData:msg];
