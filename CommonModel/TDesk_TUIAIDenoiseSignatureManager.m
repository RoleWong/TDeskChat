...
//
//  TDeskAIDenoiseSignatureManager.m
//  TUIChat
//
...
static TDeskAIDenoiseSignatureManager *gSharedInstance = nil;
...
@interface TDeskAIDenoiseSignatureManager ()
@property(nonatomic, copy, readwrite) NSString *signature;
@property(nonatomic, assign) NSTimeInterval expiredTime;
@end

@implementation TDeskAIDenoiseSignatureManager

+ (instancetype)sharedInstance {
    static dispatch_once_t once_token;
    dispatch_once(&once_token, ^{
        gSharedInstance = [[TDeskAIDenoiseSignatureManager alloc] init];
    });
