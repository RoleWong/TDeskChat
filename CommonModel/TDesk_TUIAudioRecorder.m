...
@implementation TDeskAudioRecorder
...
- (void)createRecordedFilePath {
    self.recordedFilePath = [TUIKit_Voice_Path stringByAppendingString:[TDeskTool genVoiceName:nil withExtension:@"m4a"]];
}
...
//    NSString *signature = [TDeskAIDenoiseSignatureManager sharedInstance].signature;
