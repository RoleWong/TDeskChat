...
@interface TDeskEmojiConfig : NSObject
+ (TDeskEmojiConfig *)defaultConfig;
 ...
 */
@property(nonatomic, strong) NSArray<TDeskFaceGroup *> *faceGroups;

/**
 * The list of emoticons displayed after long-pressing the message on the chat interface
 */
@property(nonatomic, strong) NSArray<TDeskFaceGroup *> *chatPopDetailGroups;
...
@interface TDeskEmojiConfig (defaultFace)
