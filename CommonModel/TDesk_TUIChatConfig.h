...
@class TDeskChatEventConfig;

typedef NS_ENUM(NSUInteger, TDeskChatRegisterCustomMessageStyleType) {
...
@interface TDeskChatConfig : NSObject

+ (TDeskChatConfig *)defaultConfig;
@property(nonatomic, strong) NSArray<TDeskFaceGroup *> *chatContextEmojiDetailGroups;
 ...
 */
@property(nonatomic, strong) TDeskChatEventConfig * eventConfig;
 ...
 */
- (BOOL)onUserIconClicked:(UIView *)view messageCellData:(TDeskMessageCellData *)celldata;
/**
 ...
 * and Chat will not process it further. Returning NO indicates that this event is not intercepted, and Chat will continue to process it.
 */
- (BOOL)onUserIconLongClicked:(UIView *)view messageCellData:(TDeskMessageCellData *)celldata;
 ...
 * and Chat will not process it further. Returning NO indicates that this event is not intercepted, and Chat will continue to process it.
 */
- (BOOL)onMessageClicked:(UIView *)view messageCellData:(TDeskMessageCellData *)celldata;
 ...
 * and Chat will not process it further. Returning NO indicates that this event is not intercepted, and Chat will continue to process it.
 */
- (BOOL)onMessageLongClicked:(UIView *)view messageCellData:(TDeskMessageCellData *)celldata;
@end
...
//
// [TDeskChatConfig.defaultConfig registerCustomMessage:@"YourBusinessID"
//                               messageCellClassName:@"YourCustomCellNameString"
//                           messageCellDataClassName:@"YourCustomCellDataNameString"];
@interface TDeskChatConfig (CustomMessageRegiser)
