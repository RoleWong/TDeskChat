//
//  TDeskCloudCustomDataTypeCenter.m
//  TUIChat
//
...
- (void)doThingsInContainsCloudCustomOfDataType:(TDeskCloudCustomDataType)type callback:(void (^)(BOOL isContains, id obj))callback {
    if (self.cloudCustomData == nil) {
        if (callback) {
            callback(NO, nil);
        }
    ...
    NSString *typeStr = [TDeskCloudCustomDataTypeCenter convertType2String:type];
...
- (BOOL)isContainsCloudCustomOfDataType:(TDeskCloudCustomDataType)type {
    if (self.cloudCustomData == nil) {
        return NO;
    }
...
@implementation TDeskCloudCustomDataTypeCenter

+ (NSString *)convertType2String:(TDeskCloudCustomDataType)type {
