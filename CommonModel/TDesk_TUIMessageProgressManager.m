...
@interface TDeskMessageProgressManager () <V2TIMSDKListener>
...
@implementation TDeskMessageProgressManager
...
- (void)uploadCallback:(NSString *)msgID {
    ...
    for (id<TDeskMessageProgressManagerDelegate> delegate in self.delegates) {
