...
@interface TUIDeslObjectFactory () <TUIObjectProtocol>

@end

@implementation TUIDeslObjectFactory
+ (void)load {
    [TDeskCore registerObjectFactory:TUICore_TUIChatObjectFactory objectFactory:[TUIDeslObjectFactory shareInstance]];
}
+ (TUIDeslObjectFactory *)shareInstance {
    static dispatch_once_t onceToken;
    static TUIDeslObjectFactory *g_sharedInstance = nil;
    dispatch_once(&onceToken, ^{
      g_sharedInstance = [[TUIDeslObjectFactory alloc] init];
    });
