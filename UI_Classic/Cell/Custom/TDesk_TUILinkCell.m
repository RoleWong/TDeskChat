...
+ (CGSize)getContentSize:(TDeskMessageCellData *)data {
    NSAssert([data isKindOfClass:TDeskLinkCellData.class], @"data must be kind of TDeskLinkCellData");
    TDeskLinkCellData *linkCellData = (TDeskLinkCellData *)data;
