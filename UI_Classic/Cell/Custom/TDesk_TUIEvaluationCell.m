...
+ (CGSize)getContentSize:(TDeskMessageCellData *)data {
    NSAssert([data isKindOfClass:TDeskEvaluationCellData.class], @"data must be kind of TDeskEvaluationCellData");
    TDeskEvaluationCellData *evaluationCellData = (TDeskEvaluationCellData *)data;
