...
@implementation TDeskVoiceReplyQuoteView
...
- (void)fillWithData:(TDeskReplyQuoteViewData *)data {
    ...
    if (![data isKindOfClass:TDeskVoiceReplyQuoteViewData.class]) {
        return;
    }
    TDeskVoiceReplyQuoteViewData *myData = (TDeskVoiceReplyQuoteViewData *)data;
