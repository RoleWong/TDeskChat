...
@implementation TDeskMergeReplyQuoteView
...
- (void)fillWithData:(TDeskReplyQuoteViewData *)data {
    ...
    if (![data isKindOfClass:TDeskMergeReplyQuoteViewData.class]) {
        return;
    }

    TDeskMergeReplyQuoteViewData *myData = (TDeskMergeReplyQuoteViewData *)data;
