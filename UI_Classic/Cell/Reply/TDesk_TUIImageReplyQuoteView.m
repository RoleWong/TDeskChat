...
@implementation TDeskImageReplyQuoteView
...
- (void)fillWithData:(TDeskReplyQuoteViewData *)data {
    ...
    if (![data isKindOfClass:TDeskImageReplyQuoteViewData.class]) {
        return;
    }
    TDeskImageReplyQuoteViewData *myData = (TDeskImageReplyQuoteViewData *)data;
...
- (void)updateConstraints {
    ...
    TDeskImageReplyQuoteViewData *myData = (TDeskImageReplyQuoteViewData *)self.data;
