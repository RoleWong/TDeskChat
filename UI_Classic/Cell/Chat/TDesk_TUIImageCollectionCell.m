...
@implementation TDeskImageCollectionCell
- (id)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        [self setupViews];
...
- (void)setupViews {
    ...
    self.animateCircleView = [[TDeskCircleLodingView alloc] initWithFrame:CGRectMake(0, 0, kScale390(40), kScale390(40))];
...
- (BOOL)largeImageSecond:(TDeskImageMessageCellData *)data {
    BOOL isExist = NO;
...
- (BOOL)originImageFirst:(TDeskImageMessageCellData *)data {
    BOOL isExist = NO;
...
- (void)fillOriginImageWithData:(TDeskImageMessageCellData *)data{
    @weakify(self);
    // originImage
...
- (void)fillLargeImageWithData:(TDeskImageMessageCellData *)data {
    @weakify(self);
    // largeImage
...
- (void)fillThumbImageWithData:(TDeskImageMessageCellData *)data {
    @weakify(self);
