 ...
 *
 *  This file declares the TDeskVoiceMessageCell class, which is responsible for implementing the display of voice messages.
...
/**
 *
 * 【Module name】 TDeskVoiceMessageCell
 ...
 *  - The TDeskVoiceMessageCellData in the voice message unit integrates and calls the voice download and acquisition of the IM SDK, and handles the related
 * business logic.
 *  - This class inherits from TDeskBubbleMessageCell to implement bubble messages. You can implement custom bubbles by referring to this inheritance
 * relationship.
 */
@interface TDeskVoiceMessageCell : TDeskBubbleMessageCell
...
@property TDeskVoiceMessageCellData *voiceData;
