...
@property(nonatomic, strong) TDeskVideoMessageCellData *videoData;
@end

@implementation TDeskVideoCollectionCell
- (id)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        [self setupViews];
...
- (void)setupViews {
    ...
    [self.mainDownloadBtn setImage:[[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath(@"download")] forState:UIControlStateNormal];
