...
@end
@interface TDeskMergeMessageCell ()
...
+ (CGSize)getContentSize:(TDeskMessageCellData *)data {
    NSAssert([data isKindOfClass:TDeskMergeMessageCellData.class], @"data must be kind of TDeskMergeMessageCellData");
    TDeskMergeMessageCellData *mergeCellData = (TDeskMergeMessageCellData *)data;
...
+ (CGSize)caculate:(TDeskMergeMessageCellData *)data index:(NSInteger)index {
