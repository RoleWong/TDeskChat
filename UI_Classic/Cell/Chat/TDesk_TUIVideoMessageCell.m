...
@interface TDeskVideoMessageCell () <TDeskMessageProgressManagerDelegate>
...
@implementation TDeskVideoMessageCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        _play.image = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath(@"play_normal")];
        _play.hidden = YES;
        ...
        _downloadImage.image = [[TDeskImageCache sharedInstance] getResourceFromCache:TUIChatImagePath(@"download")];
        ...
        _animateCircleView = [[TDeskCircleLodingView alloc] initWithFrame:CGRectMake(0, 0, kScale390(40), kScale390(40))];
...
+ (CGSize)getContentSize:(TDeskMessageCellData *)data {
    NSAssert([data isKindOfClass:TDeskVideoMessageCellData.class], @"data must be kind of TDeskVideoMessageCellData");
    TDeskVideoMessageCellData *videoCellData = (TDeskVideoMessageCellData *)data;
