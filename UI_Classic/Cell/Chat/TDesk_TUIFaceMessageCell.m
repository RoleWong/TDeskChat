...
@interface TDeskFaceMessageCell ()
@end

@implementation TDeskFaceMessageCell
...
+ (CGSize)getContentSize:(TDeskMessageCellData *)data {
    NSAssert([data isKindOfClass:TDeskFaceMessageCellData.class], @"data must be kind of TDeskFaceMessageCellData");
