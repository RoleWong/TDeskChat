...
@interface TDeskImageMessageCell ()

@property(nonatomic, strong) UIView *animateHighlightView;

@end

@implementation TDeskImageMessageCell
...
+ (CGSize)getContentSize:(TDeskMessageCellData *)data {
    NSAssert([data isKindOfClass:TDeskImageMessageCellData.class], @"data must be kind of TDeskImageMessageCellData");
    TDeskImageMessageCellData *imageCellData = (TDeskImageMessageCellData *)data;
    ...
    if (CGSizeEqualToSize(size, CGSizeZero)) {
        for (TDeskImageItem *item in imageCellData.items) {
