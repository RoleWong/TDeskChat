...
@interface TDeskMessageCellConfig : NSObject
/**
 * 1.
 *   Bind the message tableView, and TDeskMessageCellConfig will perform built-in and customized cell bindings for the tableView internally.
 */
...
@interface TDeskMessageCellConfig (MessageCellWidth)
+ (void)setMaxTextSize:(CGSize)maxTextSz;
@end

@interface TDeskMessageCellConfig (MessageCellHeight)
...
@interface TDeskMessageCellConfig (CustomMessageRegister)
