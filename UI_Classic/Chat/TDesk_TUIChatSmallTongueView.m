...
@interface TDeskChatSmallTongueView ()
...
@implementation TDeskChatSmallTongueView {
    TDeskChatSmallTongue *_tongue;
}
...
- (void)setTongue:(TDeskChatSmallTongue *)tongue {
    ...
    self.imageView.image = [TDeskChatSmallTongueView getTongueImage:tongue];
...
+ (CGFloat)getTongueWidth:(TDeskChatSmallTongue *)tongue {
...
+ (NSString *)getTongueText:(TDeskChatSmallTongue *)tongue {
...
+ (UIImage *)getTongueImage:(TDeskChatSmallTongue *)tongue {
    if (gImageCache == nil) {
...
@implementation TDeskChatSmallTongue
...
static TDeskChatSmallTongueView *gTongueView = nil;
static TDeskChatSmallTongue *gTongue = nil;
static CGFloat gBottomMargin = 0;

@implementation TDeskChatSmallTongueManager
...
+ (void)showTongue:(TDeskChatSmallTongue *)tongue delegate:(id<TDeskChatSmallTongueViewDelegate>)delegate {
    ...
    if (!gTongueView) {
        gTongueView = [[TDeskChatSmallTongueView alloc] init];
    } else {
        [gTongueView removeFromSuperview];
    }
    CGFloat tongueWidth = [TDeskChatSmallTongueView getTongueWidth:gTongue];
    if(isRTL()) {
        gTongueView.frame =
            CGRectMake(16,
