...
@interface TDeskMoreView () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
- (void)setupViews {
    ...
    _moreFlowLayout = [[TDeskCollectionRTLFitFlowLayout alloc] init];
    ...
    [_moreCollectionView registerClass:[TDeskInputMoreCell class] forCellWithReuseIdentifier:TMoreCell_ReuseId];
...
- (void)defaultLayout {
    CGSize cellSize = [TDeskInputMoreCell getSize];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    TDeskInputMoreCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:TMoreCell_ReuseId forIndexPath:indexPath];
    TDeskInputMoreCellData *data;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(moreView:didSelectMoreCell:)]) {
        if ([cell isKindOfClass:[TDeskInputMoreCell class]]) {
            [_delegate moreView:self didSelectMoreCell:(TDeskInputMoreCell *)cell];
            ;
        }
    }
}
...
- (CGSize)collectionView:(UICollectionView *)collectionView
    ...
    return [TDeskInputMoreCell getSize];
}
