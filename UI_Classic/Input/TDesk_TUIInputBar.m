...
@interface TDeskInputBar () <UITextViewDelegate, TDeskAudioRecorderDelegate>
@property(nonatomic, strong) TDeskRecordView *recordView;
...
- (TDeskRecordView *)recordView {
    if (!_recordView) {
        _recordView = [[TDeskRecordView alloc] init];
