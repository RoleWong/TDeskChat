...
@implementation TDeskResponderTextView
...
- (void)deleteBackward {
    id<TDeskResponderTextViewDelegate> delegate = (id<TDeskResponderTextViewDelegate>)self.delegate;
...
- (void)copy:(__unused id)sender {
    ...
    pasteboard.string = [[self.textStorage attributedSubstringFromRange:self.selectedRange] tdesk_getPlainString];
}
