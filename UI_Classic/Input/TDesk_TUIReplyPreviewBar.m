...
@implementation TDeskReplyPreviewBar
...
- (void)setPreviewData:(TDeskReplyPreviewData *)previewData {
    _previewData = previewData;

    NSString *abstract = [TDeskReplyPreviewData displayAbstract:previewData.type abstract:previewData.msgAbstract withFileName:YES isRisk:NO];
...
- (void)setPreviewReferenceData:(TDeskReferencePreviewData *)previewReferenceData {
    _previewReferenceData = previewReferenceData;

    NSString *abstract = [TDeskReferencePreviewData displayAbstract:previewReferenceData.type
...
@implementation TDeskReferencePreviewBar
