...
/**
 *  This file declares the TDeskInputBarDelegate protocol and the TDeskInputBar class.
 *  TUI input bar, a UI component used to detect and obtain user input.
 *  TDeskInputBar, the UI component at the bottom of the chat message. Includes text input box, emoji button, voice button, and "+" button ("More" button)
 *  TDeskInputBarDelegate provides callbacks for various situations of the input bar, including the callback for the emoticon of clicking the input bar, the
...
/////////////////////////////////////////////////////////////////////////////////
//
//                            TDeskInputBarDelegate
//
/////////////////////////////////////////////////////////////////////////////////

@protocol TDeskInputBarDelegate <NSObject>
 ...
 *  In the default implementation of TUIKit, this callback function further calls the didChangeHeight delegate in TDeskInputController to adjust the height of the
 ...
 *  In the default implementation of TUIKit, this callback further calls the didSendMessage delegate in TDeskInputController for further logical processing of
 ...
 *  In the default implementation of TUIKit, this callback function further calls the didSendMessage delegate in TDeskInputController for further logical
 ...
 */
- (void)inputBar:(TDeskInputBar *)textView didDeleteAt:(NSString *)text;
...
@interface TDeskInputBar : UIView
 ...
 *  Input view
 */
@property(nonatomic, strong) TDeskResponderTextView *inputTextView;
...
@property(nonatomic, weak) id<TDeskInputBarDelegate> delegate;
